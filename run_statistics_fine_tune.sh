...
export TRAIN_FOLDER="equal_dist" # aspirin_0.4, sas_3, druglike_0.4, equal_dist 
export COLUMN_NAME="GDB13.drug_sim,GDB13.poison_sim" # GDB13.aspirin_similarity / GDB13.sascore / GDB13.drug_sim,GDB13.poison_sim
export CONDITION="GDB13.drug_sim>=0.20#AND#GDB13.drug_sim<0.2165#AND#GDB13.poison_sim>=0.20#AND#GDB13.poison_sim<0.2165" # GDB13.aspirin_similarity>=0.4, GDB13.sascore<=3, GDB13.drug_sim>0.4#AND#GDB13.poison_sim<=0.4, GDB13.drug_sim>=0.20#AND#GDB13.drug_sim<0.2165#AND#GDB13.poison_sim>=0.20#AND#GDB13.poison_sim<0.2165
export GEN_LEN=1000000
