...
for LR in "16.00E-05" "8.00E-05"
do
accelerate launch --config_file ../accelerate_fsdp_config_22.yaml \
    ...
    --aim_exp_name "OPT_1.2B_ep_1_all_$PRE_TRAIN"_"finetune_$DATA_SPLIT"_"$MOL_REPR"_"1000K$DATA_SUF"_"$LR, valid_data=80K, sum_of_probs." \
    --seed 1 \
    --do_train \
    --do_eval \
